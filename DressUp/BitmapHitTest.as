...

{
...

        {
                ...
                public static function complexHitTestObject(target1:DisplayObject, target2:DisplayObject):Boolean
                {
                        ...
                        var scaleX:Number = (target1.width < target2.width ? target1.width : target2.width) / BitmapHitTest.tileSize 
                        //纵向缩小到tileSize尺寸需要的倍
                        var scaleY:Number = (target1.height < target2.height ? target1.height : target2.height) / BitmapHitTest.tileSize 
                        //
                        ...
                        return complexIntersectionRectangle(target1, target2 , scaleX , scaleY , pt , ct , oldHitRectangle,hitRectangle,BitmapHitTest.tileSize,BitmapHitTest.tileSize).width != 0;
                ...
                {                
                        ...
                        bitmapData.draw(target1, BitmapHitTest.getDrawMatrix(target1, hitRectangle , scaleX , scaleY ),ct);
                        ...
                        bitmapData.draw(target2, BitmapHitTest.getDrawMatrix(target2, hitRectangle , scaleX , scaleY ),ct, BlendMode.ADD);
                        ...
                        if(intersection.width!=0){                                
                                ...
                                if(scaleX>1||scaleY>1){
                                        ...
                                        if(hits<=(scaleX+scaleY)*1.5){
                                                ...
                                                var nextW:int=BitmapHitTest.tileSize
                                                var nextH:int=BitmapHitTest.tileSize
                                                ...
                                                if(intersection.width!=nowW){
                                                        nextW=BitmapHitTest.tileSize                                        
                                                }else{
                                                        nextW=nowW*2
                                                }                                
                                                if(intersection.height!=nowH){
                                                        nextH=BitmapHitTest.tileSize
                                                }else{
                                                        nextH=nowH*2
                                                }
